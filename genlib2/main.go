...
func main() {
	...
	pipeline(tensorPkgLoc, "iterator_native2.go", Kinds{allKinds}, generateNativeSelect)
	pipeline(tensorPkgLoc, "iterator_native2_test.go", Kinds{allKinds}, generateNativeSelectTests)
}
